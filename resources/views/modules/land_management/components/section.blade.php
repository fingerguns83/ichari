<div class="w-full content-center items-center my-4 bg-sky-700 rounded-2xl">
  ...
  <div id="{{$sectionName}}-details" class="flex-col bg-[#1b1c1d] pt-6 rounded-b-2xl" style="display:none;">
    <div class="w-full max-h-[240px] overflow-y-scroll scrollbar-thin scrollbar-thumb-sky-700 scrollbar-track-[#131314]">
