  <button class="flex px-2 py-1 text-2xl content-center items-center font-medium border-2 border-slate-600 rounded-xl hover:border-sky-500 hover:bg-sky-100 hover:bg-opacity-50" onclick="dialogShow()">
  ...
  @include('/layouts/dialog', ['dialog' => 'new_claim_request'])