<div class="w-full pt-8 text-sky-100">
      <div>
        <div class="block group flex-row h-14 text-3xl">
          <a href="/section/dashboard" class="cursor-default">
            @if ($show == 'dashboard')
              <div class="bg-sky-700 px-8 w-full">    
            @else
            <div class="group-hover:bg-sky-800 px-8 w-full">  
            @endif
        ...
        <div class="block group flex-row h-14 text-3xl">
          <a href="/section/claims" class="cursor-default">
            @if ($show == 'claims')
              <div class="bg-sky-700 px-8 w-full">    
            @else
              <div class="group-hover:bg-sky-800 px-8 w-full">  
        ...
        <div class="block group flex-row h-14 text-3xl">
          <a href="/section/projects" class="cursor-default">
            @if ($show == 'projects')
              <div class="bg-sky-700 px-8 w-full">    
            @else
              <div class="group-hover:bg-sky-800 px-8 w-full">  
        ...
        <div class="block group flex-row h-14 text-3xl">
          <a href="/section/polls" class="cursor-default">
            @if ($show == 'polls')
              <div class="bg-sky-700 px-8 w-full">    
            @else
              <div class="group-hover:bg-sky-800 px-8 w-full">  
        ...
        <div class="block group flex-row h-14 text-3xl">
          <a href="/section/calendar" class="cursor-default">
            @if ($show == 'calendar')
              <div class="bg-sky-700 px-8 w-full">    
            @else
              <div class="group-hover:bg-sky-800 px-8 w-full">  
