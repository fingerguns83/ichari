...
<div id="accountDialog" class="absolute grid grid-cols-6 w-full h-full z-10 top-0 left-0 bg-sky-900 dark:bg-gray-900 bg-opacity-20 dark:bg-opacity-20" style="display: none;">
